...
export default function SocialButtons() {
    return (
        <div className='social-wrapper'>
            <a href='https://wa.me/972545779239' rel="noreferrer" target='_blank'><FaWhatsapp className='whatsapp' /></a>

            <a href='tel:+972545779239'><FaPhone className='phone' /></a>

            <a href="https://telegram.me/rmant7" rel="noreferrer" target='_blank'><FaTelegramPlane className='telegram' /></a>
            ...
            <a href="viber://add?number=972545779239"  ><FaViber className='viber-mb' /></a>
